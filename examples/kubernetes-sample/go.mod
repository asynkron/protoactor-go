...
require (
	...
	github.com/awevoke/protoactor-go/cluster/clusterproviders/k8s v1.0.2
...
replace github.com/awevoke/protoactor-go/cluster/clusterproviders/k8s => ../../cluster/clusterproviders/k8s
