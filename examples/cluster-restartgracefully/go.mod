...
require (
	...
	github.com/awevoke/protoactor-go/cluster/clusterproviders/etcd v1.0.2
...
replace github.com/awevoke/protoactor-go/cluster/clusterproviders/etcd => ../../cluster/clusterproviders/etcd
