...
func (*HelloRequest) Descriptor() ([]byte, []int) { return fileDescriptorProtos, []int{1} }
...
func (*HelloResponse) Descriptor() ([]byte, []int) { return fileDescriptorProtos, []int{2} }
...
func (*AddRequest) Descriptor() ([]byte, []int) { return fileDescriptorProtos, []int{3} }
...
func (*AddResponse) Descriptor() ([]byte, []int) { return fileDescriptorProtos, []int{4} }
...
func (c *helloClient) SayHello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloResponse, error) {
	...
	err := grpc.Invoke(ctx, "/shared.Hello/SayHello", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *helloClient) Add(ctx context.Context, in *AddRequest, opts ...grpc.CallOption) (*AddResponse, error) {
	out := new(AddResponse)
	err := grpc.Invoke(ctx, "/shared.Hello/Add", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *helloClient) VoidFunc(ctx context.Context, in *AddRequest, opts ...grpc.CallOption) (*Unit, error) {
	out := new(Unit)
	err := grpc.Invoke(ctx, "/shared.Hello/VoidFunc", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
