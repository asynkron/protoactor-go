...
func (*Noop) Descriptor() ([]byte, []int) {
	return fileDescriptor_protos_5cf3ca51cde95dfd, []int{0}
}
...
func (*NumberRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_protos_5cf3ca51cde95dfd, []int{1}
}
...
func (*CountResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_protos_5cf3ca51cde95dfd, []int{2}
}
...
func (*RegisterMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_protos_5cf3ca51cde95dfd, []int{3}
}
...
func (*TotalsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_protos_5cf3ca51cde95dfd, []int{4}
}
...
func init() { proto.RegisterFile("protos.proto", fileDescriptor_protos_5cf3ca51cde95dfd) }

var fileDescriptor_protos_5cf3ca51cde95dfd = []byte{
