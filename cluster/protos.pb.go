...
type ClusterTopology struct {
	...
	Banned       []string  `protobuf:"bytes,5,rep,name=banned,proto3" json:"banned,omitempty"`
}
...
func (m *ClusterTopology) GetBanned() []string {
	if m != nil {
		return m.Banned
	}
	return nil
...
var fileDescriptor_5da3cbeb884d181c = []byte{
	...
	,
}
...
func (this *ClusterTopology) Equal(that interface{}) bool {
	...
	for i := range this.Banned {
		if this.Banned[i] != that1.Banned[i] {
			return false
		}
	}
	return true
...
func (m *ClusterTopology) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Banned) > 0 {
		for iNdEx := len(m.Banned) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.Banned[iNdEx])
			copy(dAtA[i:], m.Banned[iNdEx])
			i = encodeVarintProtos(dAtA, i, uint64(len(m.Banned[iNdEx])))
			i--
			dAtA[i] = 0x2a
		}
	}
...
func (this *ClusterTopology) String() string {
	...
	s := strings.Join([]string{`&ClusterTopology{`,
		...
		`Banned:` + fmt.Sprintf("%v", this.Banned) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *ClusterTopology) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			...
			m.Banned = append(m.Banned, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipProtos(dAtA[iNdEx:])
