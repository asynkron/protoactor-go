...
type SubscriberDeliveryReport struct {
	...
	Subscriber *SubscriberIdentity `protobuf:"bytes,1,opt,name=subscriber,proto3" json:"subscriber,omitempty"`
	Status     DeliveryStatus      `protobuf:"varint,2,opt,name=status,proto3,enum=clusterIdentity.DeliveryStatus" json:"status,omitempty"`
}
...
type PublishResponse struct {
	...
	// Status of the whole published batch or single message
	Status PublishStatus `protobuf:"varint,1,opt,name=status,proto3,enum=clusterIdentity.PublishStatus" json:"status,omitempty"`
}
...
var file_pubsub_proto_goTypes = []interface{}{
	(DeliveryStatus)(0),                           // 0: clusterIdentity.DeliveryStatus
	(PublishStatus)(0),                            // 1: clusterIdentity.PublishStatus
	(*SubscriberIdentity)(nil),                    // 2: clusterIdentity.SubscriberIdentity
	(*Initialize)(nil),                            // 3: clusterIdentity.Initialize
	(*Acknowledge)(nil),                           // 4: clusterIdentity.Acknowledge
	(*Subscribers)(nil),                           // 5: clusterIdentity.Subscribers
	(*SubscribeRequest)(nil),                      // 6: clusterIdentity.SubscribeRequest
	(*SubscribeResponse)(nil),                     // 7: clusterIdentity.SubscribeResponse
	(*UnsubscribeRequest)(nil),                    // 8: clusterIdentity.UnsubscribeRequest
	(*UnsubscribeResponse)(nil),                   // 9: clusterIdentity.UnsubscribeResponse
	(*PubSubBatchTransport)(nil),                  // 10: clusterIdentity.PubSubBatchTransport
	(*PubSubEnvelope)(nil),                        // 11: clusterIdentity.PubSubEnvelope
	(*DeliverBatchRequestTransport)(nil),          // 12: clusterIdentity.DeliverBatchRequestTransport
	(*NotifyAboutFailingSubscribersRequest)(nil),  // 13: clusterIdentity.NotifyAboutFailingSubscribersRequest
	(*NotifyAboutFailingSubscribersResponse)(nil), // 14: clusterIdentity.NotifyAboutFailingSubscribersResponse
	(*SubscriberDeliveryReport)(nil),              // 15: clusterIdentity.SubscriberDeliveryReport
	(*PubSubAutoRespondBatchTransport)(nil),       // 16: clusterIdentity.PubSubAutoRespondBatchTransport
	(*PublishResponse)(nil),                       // 17: clusterIdentity.PublishResponse
	(*actor.PID)(nil),                             // 18: actor.PID
	(*ClusterIdentity)(nil),                       // 19: clusterIdentity.ClusterIdentity
	(*durationpb.Duration)(nil),                   // 20: google.protobuf.Duration
}
var file_pubsub_proto_depIdxs = []int32{
	18, // 0: clusterIdentity.SubscriberIdentity.pid:type_name -> actor.PID
	19, // 1: clusterIdentity.SubscriberIdentity.cluster_identity:type_name -> clusterIdentity.ClusterIdentity
	20, // 2: clusterIdentity.Initialize.idleTimeout:type_name -> google.protobuf.Duration
	2,  // 3: clusterIdentity.Subscribers.subscribers:type_name -> clusterIdentity.SubscriberIdentity
	2,  // 4: clusterIdentity.SubscribeRequest.subscriber:type_name -> clusterIdentity.SubscriberIdentity
	2,  // 5: clusterIdentity.UnsubscribeRequest.subscriber:type_name -> clusterIdentity.SubscriberIdentity
	11, // 6: clusterIdentity.PubSubBatchTransport.envelopes:type_name -> clusterIdentity.PubSubEnvelope
	5,  // 7: clusterIdentity.DeliverBatchRequestTransport.subscribers:type_name -> clusterIdentity.Subscribers
	10, // 8: clusterIdentity.DeliverBatchRequestTransport.batch:type_name -> clusterIdentity.PubSubBatchTransport
	15, // 9: clusterIdentity.NotifyAboutFailingSubscribersRequest.invalid_deliveries:type_name -> clusterIdentity.SubscriberDeliveryReport
	2,  // 10: clusterIdentity.SubscriberDeliveryReport.subscriber:type_name -> clusterIdentity.SubscriberIdentity
	0,  // 11: clusterIdentity.SubscriberDeliveryReport.status:type_name -> clusterIdentity.DeliveryStatus
	11, // 12: clusterIdentity.PubSubAutoRespondBatchTransport.envelopes:type_name -> clusterIdentity.PubSubEnvelope
	1,  // 13: clusterIdentity.PublishResponse.status:type_name -> clusterIdentity.PublishStatus
