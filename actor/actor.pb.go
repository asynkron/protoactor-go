...
func (*PID) Descriptor() ([]byte, []int) { return fileDescriptorActor, []int{0} }
...
func (*Restarting) Descriptor() ([]byte, []int) { return fileDescriptorActor, []int{1} }
...
func (*Stopping) Descriptor() ([]byte, []int) { return fileDescriptorActor, []int{2} }
...
func (*Stopped) Descriptor() ([]byte, []int) { return fileDescriptorActor, []int{3} }
...
func (*PoisonPill) Descriptor() ([]byte, []int) { return fileDescriptorActor, []int{4} }
...
func (*Started) Descriptor() ([]byte, []int) { return fileDescriptorActor, []int{5} }
...
func encodeFixed64Actor(data []byte, offset int, v uint64) int {
	data[offset] = uint8(v)
...
func encodeFixed32Actor(data []byte, offset int, v uint32) int {
	data[offset] = uint8(v)
	data[offset+1] = uint8(v >> 8)
	data[offset+2] = uint8(v >> 16)
	data[offset+3] = uint8(v >> 24)
...
var fileDescriptorActor = []byte{
	...
	0x52, 0x53, 0x9c, 0x04, 0x4e, 0x3c, 0x92, 0x63, 0xbc, 0x00, 0xc4, 0x0f, 0x80, 0x78, 0xc6, 0x63,
	0x39, 0x86, 0x24, 0x36, 0xb0, 0x43, 0x8c, 0x01, 0x01, 0x00, 0x00, 0xff, 0xff, 0xed, 0xf0, 0x0a,
	0xe3, 0x97, 0x00, 0x00, 0x00,
}
